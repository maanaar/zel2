import experienceImg1 from '../../src/assets/experience1.jpeg'; // Replace with your actual images
import experienceImg2 from '../../src/assets/experience2.jpeg';

const ExperienceSection = () => {
  return (
    <div className="grid md:grid-cols-2 gap-8 items-center px-8 py-12">
      <img src={experienceImg1} alt="Event Crowd" className="rounded-2xl w-full" />
      ...
      <img src={experienceImg2} alt="Speaker on stage" className="rounded-2xl w-full md:hidden block" />
    </div>
  );
};
